...
module.exports = async (to, content) => {
  // console.log('path.resolve(__dirname, "public/output.pdf")', path.resolve(__dirname, "public/output.pdf"));
  // The from and to addresses for the email that is about to be sent.
  const contacts = {
    from: process.env.MAIL_USER,
    to,
    subject: "You successfully purchased the license.",
    // attachments: [
    //   {
    //     filename: "License.pdf",
    //     path: path.resolve(__dirname, "public/output.pdf"),
